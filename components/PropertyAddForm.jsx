...
const PropertyAddForm = () => {
    ...
    const handleAmenitiesChange = (e) => {
      ...
      const updztedAmenities = [...fields.amenities]

      if (checked) {
        //add value to array
        updztedAmenities.push(value)
      } else {
        //remove value from array
        const index = updztedAmenities.indexOf(value)

        if (index !== -1) {
          updztedAmenities.splice(index, 1)
        }
      }
